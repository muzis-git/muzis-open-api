# Открытое API
C помощью API вы можете получить доступ к ограниченной версии музыкальной базы проекта и некоторому функционалу для создания реелевантного списка трэков. Открытое API Muzis предоставляет следующие возможности:
